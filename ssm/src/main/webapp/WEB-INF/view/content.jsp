...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">广告分类</span>
					<select class="form-control" name="contentcategoryid" id = "txt_search_roleid">
						<option value="0">---请选择---</option>
						<c:forEach items="${selectByExample }" var="s">
								<option value="${s.contentcategoryid }">${s.categoryname }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>广告链接：</td>
								<td><input type="text" id="cantenturl" name="cantenturl"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>费用：</td>
	 ...
	 <div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_export_head"> 导入  </h4>
				</div>
				<div class="modal-body">
							<form id="form_user_import" action="importContent.htm" method="post" >
	...
	$(function () {
	    ...
	    //点击确认导入
	    var validator = $("#form_user_import").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	var TableInit = function () {
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            columns: [{
	                ...
	                formatter:function(value,row,index){
	                	return row.contentcategory.categoryname;
	                }
	            }, {
	                field: 'status',
	                title: '广告状态',
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contentcategoryid: $("#txt_search_roleid").val()
	        };
	        return temp;
	    };
	    return oTableInit;
